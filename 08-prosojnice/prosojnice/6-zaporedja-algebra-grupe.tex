\begin{frame}{Zaporedja, vrste in limite}
	\begin{enumerate}
		...
		\[a_n = \underbrace{\sqrt{2+\sqrt{2+\dots+\sqrt{2}}}}_{n\ korenov } \qquad b_n = \underbrace{\sin(\sin(\dots(\sin 1)\dots))}_{n\ sinusov}\]
	\end{enumerate}
\end{frame}
...
\begin{frame}{Algebra}
	\begin{enumerate}
		\item
		Vektorja $\vec{a} = \vec{a} + 2\vec{b}$ in $\vec{d} = \vec{a} - \vec{b}$
...
\begin{frame}{Grupe}
	Naj bo $G = \left\{z \in \mathbb{C}; z = 2^k(\cos(m\pi\sqrt{2}) + i\sin(m\pi\sqrt{2})), k, m \in \mathbb{Z}\right\}$ \\
	$H = \left\{(x,y) \in \mathbb{R}; x, y \in \mathbb{Z}\right\}$
	
	\begin{enumerate}
		\item
			Pokaži, da je $G$ podgrupa v grupi ($\mathbb{C} \backslash \left\{0\right\}, \cdot$)
