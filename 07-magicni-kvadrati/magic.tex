...
\begin{magic}{Magični kvadrat reda 3}{3}{mag3}
      8 & 1 & 6 \\\hline
      3 & 5 & 7 \\\hline
      4 & 9 & 2 \\\hline
\end{magic}
% Konec magičnega kvadrata
 ...
 \begin{definicija}
   Magični kvadrat reda $n$ je \pojem{\color{purple}normalen}, če v njem nastopajo števila
   \begin{equation}
      % oznaka: eq:numbers
...
\pojem{\color{purple}Lo Shu} -- ">zvitek reke Lo"<. V antični Kitajski je prišlo do
...
\begin{magic}{Kvadrat Lo Shu}{3}{loshu}
   4 & 9 & 2 \\\hline
   3 & 5 & 7 \\\hline
   8 & 1 & 6 \\\hline
\end{magic}
...
\pojem{\color{purple}Kubera-Kolam} je talna poslikava, ki se uporablja v Indiji, in je v
...
\begin{magic}{Kvadrat Kubera-Kolam}{3}{kubera}
   23 & 28 & 21 \\\hline
   22 & 24 & 26 \\\hline
   27 & 20 & 25 \\\hline
\end{magic}
...
\begin{magic}{Dürerjev magični kvadrat $4\times 4$}{4}{durer}
   16 &  3 &  2 & 13 \\\hline
   5 & 10 & 11 &  8 \\\hline
   9 &  6 &  7 & 12 \\\hline
   4 & 15 & 14 &  1 \\\hline
...
\begin{magic}{Pasijonska fasada, Sagrada Família}{4}{sagrada}
   1 & 14 & 14 &  4 \\\hline
   11 &  7 &  6 &  9 \\\hline
   8 & 10 & 10 &  5 \\\hline
   13 &  2 &  3 & 15 \\\hline
...
% Začetek dokaza
   ...
   \begin{proof}
      ...
      števil (glej~\eqref{numbers} na strani~\eqref{numbers}) enaka
...
% \begin{definicija}
      ...
      \begin{definicija}
         ...
         \pojem{\color{purple}komplementaren}.
      \end{definicija}
% \end{definicija}
...
\begin{magic}{Kvadratu Lo Shu komplementarni kvadrat}{3}{closhu}
   6 & 1 & 8 \\\hline
   7 & 5 & 3 \\\hline
   2 & 9 & 4 \\\hline
\end{magic}{}
...
% \begin{definicija}
      ...
      \begin{definicija}
         Pravimo, da sta dva magična kvadrata \pojem{\color{purple}različna}, če enega ni mogoče dobiti
...
\begin{magic}{Magični kvadrat reda 5}{5}{mag5}
   17 & 24 &  1 &  8 & 15 \\\hline
   23 &  5 &  7 & 14 & 16 \\\hline
   4 &  6 & 13 & 20 & 22 \\\hline
   10 & 12 & 19 & 21 &  3 \\\hline
...
\begin{magic}{Magični kvadrat reda 6}{6}{mag6}
...
\begin{magic}{Magični kvadrat reda 9}{9}{mag9b}
